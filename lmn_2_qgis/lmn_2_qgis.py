...
class Lmn2Qgis:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/lmn_2_qgis/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Run LMN2QGis'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start:
            ...
            self.dlg = Lmn2QgisDialog(self.iface)

        project_exists = self.dlg.check_if_project_open()
